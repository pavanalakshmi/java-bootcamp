...
import multithreading.trading_multithreading.interfaces.ChunkProcessorInterface;
...
public class ChunkProcessor implements ChunkProcessorInterface {
    private final ExecutorService executor;
    private final InsertPayloadDAO insertPayloadDAO;
    HikariDataSource dataSource;
    TradeDistributorMap tradeDistributorMap;
    TradeDistributionQueue tradeDistributionQueue;
    ...
    public ChunkProcessor() {
        ...
        tradeDistributorMap = new TradeDistributorMap();
        tradeDistributionQueue = new TradeDistributionQueue();
